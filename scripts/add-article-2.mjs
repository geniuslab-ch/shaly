// Script to add second blog article via API
...
Découvrez comment [Shaly](/) peut transformer votre stratégie avec une planification intelligente.`,
    ...
    author: "Équipe Shaly",
    published: true,
    published_at: new Date('2025-01-14T09:00:00Z').toISOString() // Publication le 14 janvier 2025 (7 jours après le 1er)
};

async function addArticle() {
    try {
        console.log('Adding article 2 to blog...');
